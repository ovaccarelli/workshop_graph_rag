...
# EXERCISE - Parameters for retrieval:
# Choose how many document chunks to retrieve for the question.
NB_RETRIEVED_CHUNKS = ...
...
# Tell it to answer only from that retrieved context and to say when the context is missing.
SYSTEM_PROMPT = "..."
...
# EXERCISE - Build relevant context:
# Join the retrieved chunks into one string that can be passed to the model.
relevant_context = "\n\n------------\n\n".join(...)
