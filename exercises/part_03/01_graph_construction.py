...
# EXERCISE - Graph schema:
# Define the small vocabulary the model should extract from the contract.
# Keep each description short and focused on parties, obligations, and dates.
...
extraction_agent = Agent(
    ...
    # EXERCISE - Deterministic extraction:
    # Set temperature to a deterministic value so repeated graph extraction is more stable.
    model_settings=ModelSettings(thinking="minimal", temperature=..., max_tokens=700),
)
